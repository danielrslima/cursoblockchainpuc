pragma solidity 0.5.12;
    ...
    //para importar uma contrato para executar devo escreve-lo como: import "./nome.sol";
    //ou executa-lo como novo contrato dentro deste contrato (vide contract Mortal is owned)
...
contract ERC20Interface {
    ...
    //balanceof eh sempre a conta do mandatario
...
contract TicketERC20 is ERC20Interface, Mortal {
    ...
    modifier hasEnoughBalance(address owner, uint amount) {
        uint balance;// checar o saldo
        balance = balances[owner];// balances e o balanceOf
        require (balance >= amount); 
        _;
        // este modifier "para que possa checar o saldo antes de fazer a transferencia
    ...
    modifier isAllowed(address spender, address tokenOwner, uint amount) {
        ...
        //o valor eh menor do que o dono lhe permitiu
        _;
    }

    modifier tokenAmountValid(uint amount) {
        //modifer geralmente eh colocado para fazer checagens. verificar se um valor eh valido
        require(amount > 0);
        _;
    }
